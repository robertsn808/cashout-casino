...
<body>
  ...
  <script type="text/javascript">
      CDNADDRESS="https://cdn.vpower777.com/";
      var backUrl = "";
  </script>
<script src="/skdm.js?v=1595603432"></script>
<script>
    var msglang='en';
    var lang='en';
    var sessionToken='SafJZPqwrMdtgm1cf6';
    var hostname = window.location.hostname;
    if (window.location.protocol == 'https:') {
        WEBSOCKETURL= 'wss://' + hostname;
        SELSVRURL='https://'+hostname+"/api/game/houtai?url=";
    } else {
        WEBSOCKETURL= 'ws://' + hostname;
        SELSVRURL='http://'+hostname+"/api/game/houtai?url=";
    }
